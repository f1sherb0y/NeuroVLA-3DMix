...
# NeighborhoodAttention stub: NATTEN not used in single-GPU inference
class NeighborhoodAttention:
    """Stub for NeighborhoodAttention (requires NATTEN library, not used in single-GPU inference)."""
    def __init__(self, *args, **kwargs):
        raise NotImplementedError(
            'NeighborhoodAttention requires the NATTEN library. '
            'It is not needed for standard single-GPU DIT inference.'
        )
