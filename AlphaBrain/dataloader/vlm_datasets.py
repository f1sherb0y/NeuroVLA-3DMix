...
from AlphaBrain.dataloader.qwenvl_llavajson.qwen_data_config import data_list
from AlphaBrain.dataloader.qwenvl_llavajson.rope2d import get_rope_index_25, get_rope_index_2
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_yaml", type=str, default="./benchmarks/LIBERO/train/alphabrain_cotrain_libero.yaml", help="Path to YAML config")
