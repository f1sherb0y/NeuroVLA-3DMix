...
from AlphaBrain.dataloader.gr00t_lerobot.datasets import ModalityConfig
from AlphaBrain.dataloader.gr00t_lerobot.transform.base import ComposedModalityTransform, ModalityTransform
from AlphaBrain.dataloader.gr00t_lerobot.transform.concat import ConcatTransform
from AlphaBrain.dataloader.gr00t_lerobot.transform.state_action import (
    StateActionSinCosTransform,
    StateActionToTensor,
    StateActionTransform,
)
from AlphaBrain.dataloader.gr00t_lerobot.transform.video import (
    VideoColorJitter,
    VideoCrop,
    VideoResize,
    VideoToNumpy,
...
class RobommePandaDataConfig:
    """Data config for RoboMME benchmark with Panda robot.
    8-dim action/state, image + wrist_image (stored as image bytes in parquet).
    """
    video_keys = [
        "video.primary_image",
        "video.wrist_image",
...
ROBOT_TYPE_CONFIG_MAP = {
    ...
    "robomme_panda": RobommePandaDataConfig(),
