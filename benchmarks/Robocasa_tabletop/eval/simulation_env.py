...
from benchmarks.Robocasa_tabletop.eval.base_config import ModalityConfig
from benchmarks.Robocasa_tabletop.eval.base_config import BasePolicy
from benchmarks.Robocasa_tabletop.eval.wrappers.multistep_wrapper import MultiStepWrapper
from benchmarks.Robocasa_tabletop.eval.wrappers.video_recording_wrapper import (
    VideoRecorder,
...
class SimulationInferenceEnv:
    ...
    def get_action(self, observations: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "video.ego_view_bg_crop_pad_res256_freq20" in observations:  # BUG: here only one view
...
class Args:
    ...
    pretrained_path: str = "results/training/1029_qwenGR00T_fourier_gr1_unified_1000_PnPMilkToMicrowaveClose_gpus_woPretrain_wState/checkpoints/steps_20000_pytorch_model.pt"
